...
import { p as parseRedirect, o as mergeHeaders, b as isRedirect, a as rootRouteId, q as getNormalizedURL, u as getOrigin, v as attachRouterServerSsrUtils, w as defineHandlerCallback, x as createSerializationAdapter, y as createRawStreamRPCPlugin, i as isNotFound, z as isResolvedRedirect, A as executeRewriteInput, C as defaultSerovalPlugins, D as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dglxi8VZ.mjs");
...
const manifest = { "940c838dc6cf882bc59c7bbb13a1fcb400f0b0c2a0f25444a03cb742303ef2e7": {
  functionName: "getHighscores_createServerFn_handler",
  importer: () => import("./highscores-DEZLZORU.mjs")
}, "1afda741c3bccd54602eece2bec99e527e28efd152a6613dfa703c2502ec76dd": {
  functionName: "saveHighscore_createServerFn_handler",
  importer: () => import("./highscores-DEZLZORU.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-BV3iBGqA.mjs").then((n) => n.r);
